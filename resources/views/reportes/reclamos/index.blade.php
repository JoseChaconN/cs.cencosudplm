<x-layout>
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
	            <div class="card-header py-3">
	                <h6 class="m-0 font-weight-bold text-primary">Buscador Reportes de Reclamos</h6>
	            </div>
	            <div class="card-body">
                    <div class="col-md-12">
                        <form method="POST" action="{{ route('reporte.reclamos')}}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
    ...
    @if ($tipo_reporte == 2)
        @include('reportes.reclamos.comercial')
    @endif
    @if ($tipo_reporte == 3)
        @include('reportes.reclamos.seccion')
    @endif
    @if ($tipo_reporte == 4)
        @include('reportes.reclamos.ciclo-3')
    @endif
    @if ($tipo_reporte == 5)
        @include('reportes.reclamos.analisis-quejas-sac')
    @endif
    @if ($tipo_reporte == 6)
        @include('reportes.reclamos.proveedores')
    @endif
    @if ($tipo_reporte == 7)
        @include('reportes.reclamos.logistica')
    @endif
    @if ($tipo_reporte == 8)
        @include('reportes.reclamos.logistica-seccion')
    @endif
    @if ($tipo_reporte == 9)
        @include('reportes.reclamos.sac')
    @endif
    @if ($tipo_reporte == 10)
        @include('reportes.reclamos.mp-general')
    @endif
<script>
