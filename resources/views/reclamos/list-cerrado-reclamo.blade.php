		...
		<div class="col-lg-12">
	        ...
	        <div class="card shadow mb-4">
	            <div class="card-header py-3">
	                <h6 class="m-0 font-weight-bold text-primary">Reclamos Cerrados</h6>
	            </div>
	            <div class="card-body">
	            	<div class="col-md-12">
	            	...
	            	<div class="col-md-12">
	            		<form method="POST" action="{{ route('listCerradoReclamo')}}">
		               		@csrf
		               		<div class="row">
		               			<div class="col-md-4">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="rutCliente" name="rutCliente" placeholder="Nombre producto" value="{{ empty($rutCliente) ? '' : $rutCliente }}">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="nomApeCliente">Nombre y/o Apellido cliente:</label>
										<input type="text" class="form-control" id="nomApeCliente" name="nomApeCliente" placeholder="Código EAN" value="{{ empty($nomApeCliente) ? '' : $nomApeCliente }}">
									</div>
								</div>
		               		</div>
					...
					@if(!empty($reclamos))
					    <div class="col-lg-12 mb-4">
					    	<div class="card shadow mb-4">
					            <div class="card-header py-3">
					                <h6 class="m-0 font-weight-bold text-primary">Otros Reclamos Cerrados</h6>
					            </div>
					            <div class="card-body">
					                <div class="table-responsive">
					                    <table class="table table-bordered table-striped table-condensed table-hover dataTable"  width="100%" cellspacing="0">
